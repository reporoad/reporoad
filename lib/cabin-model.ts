...
export function cabinDashboardModel(): VoxelPart[] {
  ...
  add([-0.745, -0.704, -1.43], [0.95, 0.062, 0.03], '#505035');
  add([-0.745, -0.8575, -1.43], [0.95, 0.245, 0.03], '#34362a');
  ...
  // Brighter upper timber lip, with a darker lower surround at the footwell.
  add([0.035, -0.964, -1.418], [0.63, 0.038, 0.018], '#78684b', true);
  add([0.035, -1.079, -1.418], [0.63, 0.192, 0.018], '#59442e', true);
  for (let i = 0; i < 5; i++) {
