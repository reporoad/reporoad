...
export function cabinDashboardModel(): VoxelPart[] {
  ...
  add([-0.745, -0.5375, -1.48], [0.95, 0.205, 0.08], olive);
  add([-0.745, -0.655, -1.44], [0.95, 0.03, 0.035], '#454734');
  add([-0.745, -0.681, -1.445], [0.95, 0.018, 0.025], shadow);
  add([-0.745, -0.835, -1.43], [0.95, 0.29, 0.03], '#34362a');
  for (const x of [-1.22, -0.27])
    add([x, -0.5375, -1.434], [0.016, 0.205, 0.025], shadow);
